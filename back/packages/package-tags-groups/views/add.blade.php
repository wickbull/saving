...
@section('title') {{_('Create tags group')}} @endsection
		...
		<div class="bg-light lter b-b wrapper-md">
			<div class="row">
				<div class="col-md-6">
					...
					<small class="text-muted">{{_('Create group')}}</small>
				</div>
			</div>
		</div>
				...
				<div class="panel-body m-t-md">
					...
					{!! Form::open() !!}
						...
						<div class="col-sm-12 text-right">
							...
							<button type="submit" class="btn btn-primary">{{_('Create Tags Group')}}</button>
						</div>
