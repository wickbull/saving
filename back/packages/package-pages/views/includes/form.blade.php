...
<div class="form-group">
	...
	<div class="input-group m-b">
		{!! Form::input('text', 'slug', null, ['class' => 'form-control js-slug', 'data-require' => 'slug', 'data-source' => 'input[name=title]', 'data-locker' => '#slug-locker', 'data-check' => action('\Packages\PackagePagesController@getCheckSlug'), 'data-check-status' => '#slug-check-status', 'placeholder' => _('Enter slug')]) !!}
