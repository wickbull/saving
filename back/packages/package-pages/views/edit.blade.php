				...
				<div class="bg-light lter b-b wrapper-md">
					<div class="row">
						<div class="col-md-6">
							...
							<small class="text-muted">{{ _('Edit page') }}</small>
						</div>
						<div class="pull-right padder">
							{!! Form::open(['method' => 'DELETE', 'url' => action('\Packages\PackagePagesController@deleteDelete', $page)]) !!}
								<button class="btn btn-danger">{{ _('Delete page') }}</button>
							{!! Form::close() !!}
						</div>
					</div>
				</div>
