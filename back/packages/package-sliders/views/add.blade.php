...
@section('title') {{ _('Slider add') }} @endsection
        ...
        <div class="col">
            <div class="vbox">
                ...
                <div class="bg-light lter b-b wrapper-md">
                    ...
                    <small class="text-muted">{{ _('Add slider') }}</small>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        {!! Form::open(['class' => 'js-garlic']) !!}
                                            ...
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button type="submit" class="btn btn-primary">{{ _('Create new slider') }}</button>
                                            </div>
